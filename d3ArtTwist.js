const d3ArtTwistBox = document.getElementById("d3ArtTwistBox").getBoundingClientRect();
let w = d3ArtTwistBox.width;
let h = d3ArtTwistBox.height;
...
let svg = d3.select("#d3ArtTwistBox")
  .append("svg")
  .attr("width", w)
  .attr("height", h)
