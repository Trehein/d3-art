const d3ArtFlipBox = document.getElementById("d3ArtFlipBox").getBoundingClientRect();
let w = d3ArtFlipBox.width;
let h = d3ArtFlipBox.height;
...
let svg = d3.select("#d3ArtFlipBox")
  .append("svg")
  .attr("width", w)
  .attr("height", h)
