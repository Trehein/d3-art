const d3ArtBox = document.getElementById("d3ArtBox").getBoundingClientRect();
let w = d3ArtBox.width;
let h = d3ArtBox.height;
...
var tri1TransitionData = [
  {'x':center + 12.5, 'y':hyp - 25},
  {'x':center + (hyp/2)*Math.sqrt(3) + 12.5, 'y': center - (hyp/2) - 25},
  {'x':center + 12.5, 'y':center - 25}
]
...
var tri2TransitionData = [
  {'x':center + (hyp/2)*Math.sqrt(3) + 25, 'y': center - (hyp/2)},
  {'x':center + (hyp/2)*Math.sqrt(3) + 25, 'y': center + (hyp/2)},
